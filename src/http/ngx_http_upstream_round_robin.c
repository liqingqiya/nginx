...
ngx_int_t
ngx_http_upstream_init_round_robin(ngx_conf_t *cf,      /*ngx_conf_t ? ngx_http_upstream_srv_conf_t ? todo*/
    ...
    ngx_http_upstream_srv_conf_t *us)
{
    ...
    r->upstream->peer.get = ngx_http_upstream_get_round_robin_peer;     /*设置了两个个回调函数*/
